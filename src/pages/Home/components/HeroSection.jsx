...
function HeroSection() {
  return (
    <section className="relative bg-gradient-to-br from-[#000000]/20 via-gray-300 to-gray-400 min-h-[75vh] flex items-center px-32 py-20">
      <div className="w-full flex items-center justify-between gap-16">
        <div className="flex-1 max-w-2xl">
          ...
          <p className="text-white text-base mb-6 leading-relaxed max-w-xl opacity-80 ">
